...
class RunArg(str, Enum):
    ...
    IMAGE_FILE_LANDSCAPE = ('image-file-landscape', 'ifl', 'str', True, True)
    IMAGE_FILE_PORTRAIT = ('image-file-portrait', 'ifp', 'str', True, True)
    IMAGE_FILE_SQUARE = ('image-file-square', 'ifs', 'str', True, True)
