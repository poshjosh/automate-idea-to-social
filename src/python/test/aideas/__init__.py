...
__test_content_dir = f'{__test_downloads_dir}/test-content'
os.environ[Env.AGENTS_DIR.value] = f'{__test_resources_dir}/agent'
...
os.environ[Env.OUTPUT_DIR.value] = __test_downloads_dir
