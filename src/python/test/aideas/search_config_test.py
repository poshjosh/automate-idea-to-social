...
class SearchConfigTest(unittest.TestCase):
    def test_to_attr_dict_should_succeed_given_single_pair(self):
        k = "name"
        v = "value"
        attr: dict[str, str] = SearchConfig.to_attr_dict(f"{k}={v}")
    ...
    def test_to_attr_dict_should_succeed_given_multiple_pairs(self):
        ...
        k1 = "name0"
        v1 = "value0"
        attr: dict[str, str] = SearchConfig.to_attr_dict(f"{k0}={v0} {k1}={v1}")
    ...
    def test_to_attr_dict_should_fail_given_multiple_pairs_with_misplaced_quotes(self):
        ...
        k1 = "name1"
        v1 = "value1 with spaces"
        self.assertRaises(ValueError, SearchConfig.to_attr_dict, f'{k0}="{v0} {k1}={v1}')
