...
- Implement adding of youtube video to playlist
- Bump content-publisher to v0.0.13
...
- Bump content-publisher to v0.0.11.
...
- Bump [content-publisher](https://github.com/poshjosh/content-publisher.git) to v0.0.7.
- Use `pyproject.toml`
...
- Bug in json handling

### Added

- Health status endpoint `/info/health/status`.
